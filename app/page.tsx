        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Give your brain superpowers with our AI-powered note-taking and
              thinking tool
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Button
                ...
                className="border-purple-500/30 text-white hover:bg-purple-500/10 text-lg py-6 px-8">
                  <Link href="/docs/advanced/keyboard-shortcuts">See how it works</Link>
              </Button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Reflect combines the best of note-taking, journaling, and AI
              assistance in one seamless experience
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <div className="inline-block px-3 py-1 rounded-full bg-purple-900/20 text-purple-400 text-sm font-medium mb-4">
                <Button className="py-6 px-8 text-purple-100">
                  <Link href="/support">Chat Support AI</Link>
                </Button>
              </div>
              <h2 className="text-3xl md:text-5xl font-bold mb-6 purple-gradient-text">
                Notes with an AI
              ...
              <p className="text-xl text-gray-300 mb-8">
                Reflect's AI chat support helps you organize your thoughts,
                generate ideas, and make connections between concepts you might
                have missed.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Ask your AI to brainstorm ideas, outline projects, or
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Discover relationships between your notes that you might
                      have missed
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Let AI handle the busy work so you can focus on what
                      matters
                    </p>
                  </div>
                </div>
            ...
            <div className="lg:w-1/2">
              <div className="relative purple-glow rounded-xl overflow-hidden border border-purple-500/20">
                <div className="absolute inset-0 bg-gradient-to-b from-purple-600/10 to-transparent"></div>
                <Image
                  src="/Svg/Note.svg?height=600&width=600"
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Your notes are encrypted and backed up automatically, so you never
              have to worry about losing your thoughts
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="feature-card">
              ...
              <h3 className="text-xl font-bold mb-2">End-to-End Encryption</h3>
              <p className="text-gray-400">
                Your notes are encrypted before they leave your device, ensuring
            ...
            <div className="feature-card">
              ...
              <h3 className="text-xl font-bold mb-2">Global Sync</h3>
              <p className="text-gray-400">
                Access your notes from any device, anywhere, anytime with
            ...
            <div className="feature-card">
              ...
              <p className="text-gray-400">
                We never sell your data or show you ads. Your thoughts are yours
                alone
              </p>
            </div>
            <div className="feature-card">
              ...
              <p className="text-gray-400">
                We continuously improve our security measures to keep your notes
                safe
              </p>
            </div>
            <div className="feature-card">
              ...
              <p className="text-gray-400">
                You own your data. Export your notes anytime in standard formats
              </p>
              </div>
          </div>
        </div>
            ...
            <div className="feature-card text-center relative overflow-hidden">
              ...
              <ul className="space-y-3 text-left mb-8">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-300">AI included</span>
                </li>
                <li className="flex items-center">
                  <div className="w-5 h-5 rounded-full bg-purple-900/30 flex items-center justify-center mr-3">
                    <svg

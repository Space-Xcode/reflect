      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-3xl mx-auto mb-12">
          ...
          <div className="flex items-center mb-8">
            <div className="w-12 h-12 rounded-full overflow-hidden mr-4">
              <Image
                src={post.author.avatar || "/muhammad.svg"}
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="relative purple-glow rounded-xl overflow-hidden border border-purple-500/20">
            ...
            <Image
              src={post.coverImage || "muhammad.svg"}
              alt={post.title}
              width={1200}
              height={675}
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul>
              ...
              <li>
                ...
                the AI Chat helping to overcome writer's block.
              </li>
              <li>
            ...
            {relatedPosts.map((relatedPost) => (
              <div key={relatedPost.slug} className="feature-card">
                <div className="relative rounded-lg overflow-hidden mb-4 aspect-video">
                  <Image
                    src={relatedPost.coverImage || "/muhammad.svg"}

          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="feature-card text-center">
              <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-6 purple-glow-sm">
                <Image
                  src="/user2.jpg?height=128&width=128"
                  alt="Team Member"
                  width={128}
                  height={128}
            ...
            <div className="feature-card text-center">
              <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-6 purple-glow-sm">
                <Image
                  src="/user1.jpg?height=128&width=128"
                  alt="Team Member"
                  width={128}
                  height={128}
                  className="w-full h-full object-cover"
            ...
            <div className="feature-card text-center">
              <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-6 purple-glow-sm">
                <Image
                  src="/user3.jpg?height=128&width=128"
                  alt="Team Member"
                  width={128}
                  height={128}
                  className="w-full h-full object-cover"
            ...
            <div className="feature-card text-center">
              <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-6 purple-glow-sm">
                <Image
                  src="/user4.jpg?height=128&width=128"
                  alt="Team Member"
                  width={128}
                  height={128}
                  className="w-full h-full object-cover"
            ...
            <div className="feature-card text-center">
              <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-6 purple-glow-sm">
                <Image
                  src="/user5.jpg?height=128&width=128"
                  alt="Team Member"
                  width={128}
                  height={128}
                  className="w-full h-full object-cover"
            ...
            <div className="feature-card text-center">
              <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-6 purple-glow-sm">
                <Image
                  src="user6.jpg?height=128&width=128"
                  alt="Team Member"
                  width={128}
                  height={128}
                  className="w-full h-full object-cover"

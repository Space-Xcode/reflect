...
export default function SupportPage(count: number) {
  ...
  const users = [
    {
      ...
      avatar: "/user2.jpg?height=40&width=40",
    },
    {
      id: "user-2",
      name: "Emily Johnson",
      email: "emily.johnson@example.com",
      avatar: "/user1.jpg?height=40&width=40",
    },
    {
      id: "user-3",
      name: "Michael Brown",
      email: "michael.brown@example.com",
      avatar: "/user3.jpgheight=40&width=40",
    },
    {
      id: "user-4",
      name: "Sarah Davis",
      email: "sarah.davis@example.com",
      avatar: "/user4.jpg?height=40&width=40",
    },
    {
      id: "user-5",
      name: "David Wilson",

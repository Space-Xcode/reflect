...
export const docsSearchResults = [
  ...
  },
  {
    ...
    content:"Reflect's AI chat allows you to interact with your notes in a conversational way. You can ask questions, generate summaries, and brainstorm ideas.",
    href: "/docs/features/ai-assistant",
  },
  {
    title: "Note Taking",
    content:
      "Learn how to create, edit, and organize notes in Reflect. Discover features like rich text formatting, tagging, and linking notes together.",
  ...
  },
  {
    ...
    content:
      "Integrate Reflect with your own tools and workflows using our comprehensive API.",
    href: "/docs/advanced/api",
  },
  {
    title: "Troubleshooting Sync Issues",
    content:
      "Learn how to resolve common synchronization problems between devices.",
    href: "/docs/troubleshooting/common-issues",
  },
  {
    title: "Video Tutorials",
    content:
      "Watch step-by-step video tutorials to learn how to use Reflect's features effectively.",
  ...
  categories: [
    ...
    },
    {
      ...
      videos: [
        {
          id: "ai-assistant",
          title: "Mastering the AI Chat",
          description:
            "Discover the full potential of Reflect's AI chat. This tutorial shows you how to use AI to generate ideas, summarize content, create outlines, and make connections between your notes.",
          ...
          timestamps: [
            { time: "0:00", label: "Introduction to the AI chat" },
          ...
          relatedDocs: [
            { title: "AI Chat", href: "/docs/features/ai-assistant" },
            {
              title: "Advanced AI Usage",
              href: "/docs/advanced/ai-customization",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          relatedDocs: [
            { title: "Search", href: "/docs/features/search" },
            {
              ...
              href: "/docs/advanced/search-syntax",
            },
          ],
        },
      ],
          ...
          relatedDocs: [
            {
              ...
              href: "/docs/guides/daily-journaling",
            },
          ...
          relatedDocs: [
            {
              ...
              href: "/docs/guides/project-management",
            },
